...
namespace GraphicsModule
{
  ...
  HRESULT test::InitDevice(HWND _hwnd)
  {
    ...
    BUFFER_DESC_DX11 bd2;
    ZeroMemory(&bd2, sizeof(bd2));
    bd2.Usage = D3D11_USAGE_DEFAULT_DX11;
    ...
    hr = g_pd3dDevice->CreateBuffer(reinterpret_cast<D3D11_BUFFER_DESC*>(&bd2), &InitData2, &g_pVertexBuffer2->getyBufferDX11());
    if (FAILED(hr))
      return hr;
    ...
    hr = g_pd3dDevice->CreateBuffer(reinterpret_cast<D3D11_BUFFER_DESC*>(&bd2), &InitData2, &g_pIndexBuffer2->getyBufferDX11());
    if (FAILED(hr))
      return hr;
